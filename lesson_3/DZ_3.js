...
function main() {
    ...
    let basketGoods = [
        new BasketGood(1, "shoes", "empty", [35,36], 3000, 20),
        new BasketGood(2, "hat", "empty", [35,36], 2000, 0),
        new BasketGood(3, "dress", "empty", [35,36], 5000, 6),
        new BasketGood(4, "shirt", "empty", [35,36], 3500, 1),
        new BasketGood(5, "scarf", "empty", [35,36], 1000, 0),
    ]
